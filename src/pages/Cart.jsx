...
const Cart = () => {
    ...
    const [selectedAddrss, setSelectedAddress] = useState(dummyAddress[0])
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button onClick={()=>{navigate("/products"); scrollTo(0,0)}} className="group cursor-pointer flex items-center mt-8 gap-2 text-indigo-500 font-medium">
                   <img className="group-hover:-translate-x-1 transition" src={assets.Arrow_icon} alt="arrow"/>
                    Continue Shopping
                </button>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddrss ? `${selectedAddrss.street}, ${selectedAddrss.city}, ${selectedAddrss.province}, ${selectedAddrss.country}` : "No address found"}</p>
